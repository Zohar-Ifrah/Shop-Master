export function About() {
    return (
        <section className="about-container">
            ...
            <h2>Our Mission</h2>
            <p>
                At Shop-Master, our mission is to revolutionize the way retailers manage their inventory. We strive to provide an intuitive and user-friendly interface that makes product management accessible for everyone, regardless of technical expertise.
            </p>

            <h2>What We Offer</h2>
            <ul>
                <li>User-friendly interface for adding, editing, and deleting products</li>
            ...
            <h2>Our Values</h2>
            <p>
                We value innovation, integrity, and customer satisfaction. Our development process is guided by these principles to ensure we deliver high-quality solutions that meet the evolving needs of our users.
            </p>

            <h2>Join the Shop-Master Community</h2>
            <p>
